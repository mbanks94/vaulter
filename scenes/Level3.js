export default class Level3 extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.tilemapTiledJSON('map3', '/tiles/level3.json');
    this.load.atlas('knight', '/sprites/knight.png', '/sprites/knight.json');
    this.load.atlas('loot', '/sprites/loot.png', '/sprites/loot.json');
    this.load.atlas('mace', '/sprites/mace.png', '/sprites/mace.json');
    this.load.atlas('bigZom', '/sprites/bigZom.png', '/sprites/bigZom.json');
